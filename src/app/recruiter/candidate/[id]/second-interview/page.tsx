...
export default function SecondInterviewPage() {
  ...
  async function loadData() {
    try {
      ...
      if (interviewData.second_interview_overall) {
        setResults({
          second_technical: interviewData.second_interview_technical,
          second_problem: interviewData.second_interview_problem,
          second_communication: interviewData.second_interview_communication,
          second_experience: interviewData.second_interview_experience,
          second_professionalism: interviewData.second_interview_professionalism,
          second_overall: interviewData.second_interview_overall,
          combined_score: interviewData.combined_score,
          recommendation: interviewData.combined_recommendation,
        ...
        setFirstInterview({
          ...
          technical_knowledge_score: interviewData.technical_knowledge_score,
          problem_solving_score: interviewData.problem_solving_score,
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setFirstInterview(data.first_interview);
    } catch {
  ...
  if (results && firstInterview) {
    const dimensions = [
      ...
      { label: "Problem Solving", first: firstInterview.problem_solving_score, second: results.second_problem },
      { label: "Communication", first: firstInterview.communication_score, second: results.second_communication },
      { label: "Experience Depth", first: firstInterview.experience_depth_score, second: results.second_experience },
      { label: "Professionalism", first: firstInterview.professionalism_score, second: results.second_professionalism },
    ];
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  ...
                  <tr className="font-bold">
                    ...
                    <td className="text-center font-mono">{firstInterview.overall_score}/100</td>
